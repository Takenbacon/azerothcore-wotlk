...
class AuthSession final : public TcpSocket<AuthSession>
{
...
protected:
    virtual bool ReadHeaderHandler() { return true; };
    virtual ReadDataHandlerResult ReadDataHandler() { return ReadDataHandlerResult::Ok; };
