...
std::shared_ptr<WorldSocket> WorldSocketMgr::OnWorldSocketOpen(IoContextTcpSocket&& sock, uint32 threadIndex)
{
    ...
    return BaseSocketMgr::OnSocketOpen(std::move(sock), threadIndex);
}
