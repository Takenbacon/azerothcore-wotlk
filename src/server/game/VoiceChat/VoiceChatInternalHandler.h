...
#ifndef __VOICECHAT_INTERNALHANDLER_H__
#define __VOICECHAT_INTERNALHANDLER_H__
...
extern VoiceChatInternalOpcodeTable<VoiceChatMgr> internalVoiceChatOpcodeTable;
